...
export function App() {
  ...
  return (
    <>
      ...
      <footer>TradeWarz is software you run yourself. It is not investment advice, and trading these markets can lose everything you put in. {info ? <>Hub v{info.version}{info.build ? <> · build <span title="hub build id">{info.build.slice(0, 7)}</span></> : null}.</> : ''} · <a href="#privacy" onClick={(e) => { e.preventDefault(); showPrivacy(); }}>Privacy</a> · <a href="#terms" onClick={(e) => { e.preventDefault(); showTerms(); }}>Terms</a> · <a href="#risk" onClick={(e) => { e.preventDefault(); showRisk(); }}>Risk</a> · <a href={TG_CHANNEL_URL} target="_blank" rel="noopener noreferrer">Channel</a> · <a href={TG_CHAT_URL} target="_blank" rel="noopener noreferrer">Chat</a> · <a href={X_URL} target="_blank" rel="noopener noreferrer">X</a> · <a href={REPO_URL} target="_blank" rel="noopener noreferrer">GitHub</a></footer>
    </>
  );
}
