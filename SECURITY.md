...
Please do not test against other people's wallets or the live hosted service, and do not open a
public issue or post about a funds-at-risk bug before it is fixed.
...
The hosted matchmaking/API service is not in this public repository; report issues that affect
it through the same private vulnerability channel if they put funds at risk.

Out of scope: third-party services the client talks to (DexScreener, GeckoTerminal, CoinGecko,
CoinMarketCap, GoPlus, PumpPortal, Jupiter, KyberSwap, public RPCs) and wallet extensions
